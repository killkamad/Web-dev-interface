...
function _load_jestDocblock() {return _jestDocblock = _interopRequireWildcard(require('jest-docblock'));}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key];}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};} /**
...
(_jestJasmine || _load_jestJasmine()).default;exports.default = (() => {var _ref = _asyncToGenerator(function* (path, globalConfig, config,
  resolver)
  {
    let testSource;
    ...
    try {
      ...
      return new Promise(function (resolve) {return setImmediate(function () {return resolve(result);});});
    } finally {
      yield environment.teardown();
    }
  });function runTest(_x, _x2, _x3, _x4) {return _ref.apply(this, arguments);}return runTest;})();